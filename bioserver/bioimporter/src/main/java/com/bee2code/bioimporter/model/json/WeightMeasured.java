...
/**
 * Measured total body mass given in kilograms (accuracy to 100 g)
 */
@ApiModel(description = "Measured total body mass given in kilograms (accuracy to 100 g)")
@Validated
...
public class WeightMeasured {
	...
	public WeightMeasured dataAvailability(DataAvailability dataAvailability) {
	...
	**/
	...
	public WeightMeasured weight(BigDecimal weight) {
		this.weight = weight;
		return this;
	}
	...
	**/
	...
	public WeightMeasured timestamp(MeasurementDate timestamp) {
	...
	**/
	...
	public boolean equals(java.lang.Object o) {
		...
		WeightMeasured weightMeasured = (WeightMeasured) o;
		return Objects.equals(this.dataAvailability, weightMeasured.dataAvailability)
				&& Objects.equals(this.weight, weightMeasured.weight)
				&& Objects.equals(this.timestamp, weightMeasured.timestamp);
	}
	...
	public String toString() {
		...
		sb.append("class WeightMeasured {\n");
