...
public class BasicPaginationQueryRequest {
	...
	@JsonProperty
	private boolean searchInDispersion;
	...
	public boolean isSearchInDispersion() {
		return searchInDispersion;
	}

	public void setSearchInDispersion(boolean searchInDispersion) {
		this.searchInDispersion = searchInDispersion;
	}
